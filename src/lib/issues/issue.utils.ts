import type { BrewIssue, IssueStatus, LinkRef, Slide, SlideType } from '@lib/models';

const ALLOWED_STATUS: IssueStatus[] = ['ready', 'enriched', 'audio_ready', 'failed'];
...
const ensured = normalized.url ? normalized : { ...normalized, url: `#missing-link-${index}` };
return ensured;
});
